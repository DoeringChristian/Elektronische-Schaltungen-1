...
\newcommand{\circuit}[2]{%
	...
	{\parbox{\linewidth}{\includegraphics[width=\linewidth]{#2}\\\begin{flushleft}#1\hfill\end{flushleft}}\ \\}}
...
\circuit{Differenzstufe mit Diodenlast}{img/Logo.pdf}

\circuit{x1}{img/Logo.pdf}

\circuit{x2}{img/Logo.pdf}

\circuit{x3}{img/Logo.pdf}
...
\circuit{Invertierender Verstärker mit Offset}{img/invertierender-verstärker-mit-offset.pdf}
...
\circuit{Komparator}{img/komparator.pdf}
Schaltschwellen: $ $\\
