...
\begin{circuit}{Differenzstufe mit Stromspiegel-Last (nMOS)}{img/differenzstufe-mit-stromspiegel-last-2.pdf}
	Differenzverstärkung $A_{\ir diff} \approx -\frac{g_{\ir m2}}{g_{\ir DS2}+g_{\ir DS3}}$\\
	Gleichtaktverstärkung $A_{\ir cm} \approx -\frac{g_{\ir DS0}g_{\ir DS2}}{2g_{\ir m3}(g_{\ir DS2}+g_{DS3})}$\\
	Gleichtaktunterdrückung CMRR = $\frac{A_{\ir diff}}{A_{\ir cm}} \approx 2 \frac{g_{\ir m3}}{g_{\ir DS0}}\frac{g_{\ir m2}}{g_{\ir DS2}}$
\end{circuit}
\begin{circuit}{Differenzstufe mit Diodenlast}{img/differenzstufe-mit-diodenlast.pdf}
%TODO
\end{circuit}
...
\begin{circuit}{AD Wandler}{img/ad-widerstand.pdf}
	...
	Gain Error: $\text{GE} = \sum\Delta_{\ir meas} - V_{ref}$\\
...
\begin{circuit}{DA Wandler (Widerstände)}{img/da-widerstand.pdf}
	...
	Unterreferenzwerte: $V_r = \frac{\text{Widerstandswert bis zur Referenz}}{\text{Gesamtwiderstand}}V_{\ir ref}$\\
	Quantisierungsschrittschawankung: $\Delta_{\ir meas} = V_{r_n+1}-V_{r_n}$\\
	Differentielle Nichtlinearität: $\text{DNL}(n) = \frac{\Delta_{\ir meas}-\Delta}{\Delta}$ \quad $\text{DNL}_{\ir spec} = \frac{\max{(\Delta_{\ir meas})}-\Delta}{\Delta}$\\
